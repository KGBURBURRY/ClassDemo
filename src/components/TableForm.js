...
export default function TableForm({ description, setDescription, quantity, setQuantity, price, setPrice, amount, setAmount, list, setList, total, setTotal }) {
    ...
    return (
        <>
            ...
            <table width="100%" className="mb-10">
                <thead>
                    <tr className="bg-gray-100 p-1">
                        ...
                        <td colspan="2" className="font-bold">Actions</td>
                    </tr>
                </thead>
                    ...
                    <React.Fragment key={id}>
                        <tbody>
                            <tr>
                                ...
                                <td><button onClick={() => editRow(id)}><AiOutlineEdit className="text-blue-500 font-bold text-2xl" /></button></td>
                            </tr>
                        </tbody>
                    </React.Fragment>
                ))}
            ...
            <div>
                <h2 className="flex items-end justify-end text-gray-800 text-2xl">USD. {total.toLocaleString()} $</h2>
            </div>
        </>
    )
}